    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.FormWrapper}>
          ...
          <TextInput
            style={[styles.CUS, { marginLeft: 20 }]}
          ...
          <View style={{ flexDirection: "row", paddingLeft: 20 }}>
            ...
            <TextInput
              style={[styles.CUS, { width: "30%", marginRight: "1.5%" }]}
              placeholderTextColor="#202020"
          ...
          <View style={{ flexDirection: "row", paddingLeft: 20 }}>
            ...
            <Text
              style={[styles.CUS, { width: "46%", marginLeft: "1%" }]}
              placeholderTextColor="#202020"
              placeholder="Tax"
              keyboardType="numeric"
            >
              {prod.final_price != null ? prod.final_price : "Final Price"}
            </Text>
          </View>

          <View
            style={{ flexDirection: "row", marginBottom: 10, paddingLeft: 20 }}
          >
            <ModalDropdown
          ...
          {!prod.gender == "" && (
            ...
            >
              ...
              />
              <ModalDropdown
                options={Object.keys(gender[prod.gender])}
          ...
          {(prod.category == "Boots" || prod.category == "Heels") && (
            ...
            >
              <ModalDropdown
                options={gender[prod.gender][prod.category]}
          ...
          <View style={{ paddingLeft: 20, paddingTop: 20 }}>
            ...
            >
              <CheckBox
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 1: !isSelected[1] });
                }}
              />
              <CheckBox
                label="2"
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 2: !isSelected[2] });
                }}
              />
              ...
              <CheckBox
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 3: !isSelected[3] });
                }}
              />
              <CheckBox
                label="4"
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 4: !isSelected[4] });
                }}
              />
            </View>
            ...
            >
              <CheckBox
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 5: !isSelected[5] });
                }}
              />
              <CheckBox
                label="6"
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 6: !isSelected[6] });
                }}
              />
              <CheckBox
                label="7"
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 7: !isSelected[7] });
                }}
              />
              <CheckBox
                label="8"
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 8: !isSelected[8] });
                }}
              />
            </View>
            ...
            >
              <CheckBox
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 9: !isSelected[9] });
                }}
              />
              <CheckBox
                label="10"
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 10: !isSelected[10] });
                }}
              />
              ...
              <CheckBox
                ...
                onChange={(checked, label) => {
                  setSelection({ ...isSelected, 11: !isSelected[11] });
                }}
              />
            </View>
          ...
          <TouchableOpacity style={styles.SignBtn} onPress={PickImage}>
                  ...
                  Alert.alert("Error", "Please add Sizes and Colors", [
                    {
                      text: "OK",
                      onPress: () => {
                        console.log(size.length, Object.keys(details).length);
                      },
                    },
                  ]);
                }
