    ...
    return (
        ...
        <ScrollView>
            ...
            {/* This is section for the shop logo and header section */}
                <Image source={require('E:/Surabhi/TYBCA/Project/Project Code File/Shoe-Admin/images/shoe.jpg')} style={styles.logo}></Image>
            ...
            <View style={styles.login}>
                    ...
                    <   TouchableOpacity onPress={(e)=>navigation.navigate("AdminReg")}><Text style={{textDecorationLine:"underline",color:"red"}}>Register Here</Text></TouchableOpacity>
                    </View>
            </View>
            </ScrollView>
            </View>
