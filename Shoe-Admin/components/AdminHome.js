    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{height:500,paddingTop:80,paddingLeft:20,}}>
                ...
                />  
                <Text style={{color:"#FFFFFF",fontSize:30,marginTop:20,marginBottom:20}}>Hello Admin,</Text>
                ...
                <View style={{paddingLeft:"5%",marginTop:25}}>
                    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                        ...
                        <TouchableOpacity style={{alignItems:'center'}} onPress={()=>navigation.navigate("VendorReg")}>
                            <Icon
                            size={90}
                            name={"user-plus"}
                            color="white"
                            ...
                            />  
                            <Text style={{fontSize:18,color:"#FFFFFF",fontWeight:"bold"}}>Register Vendor</Text>
                        </TouchableOpacity>
                        </View>
                        <View style={{flexDirection:"column",width:170,height:170,backgroundColor:'rgba(237, 237, 237,0.4)',justifyContent:'center',alignItems:"center",borderRadius:20,marginRight:20}}>
                        <TouchableOpacity style={{alignItems:'center'}}>
                            ...
                            />  
                            <Text style={{fontSize:18,color:"#FFFFFF",fontWeight:"bold"}}>Remove Vendor</Text>
                        </TouchableOpacity>
                        </View>
                        {/* <View style={{flexDirection:"column",width:170,height:170,backgroundColor:'rgba(237, 237, 237,0.4)',justifyContent:'center',alignItems:"center",borderRadius:20,marginRight:20}}>
                        <TouchableOpacity style={{alignItems:'center'}}>
